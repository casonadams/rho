...
use crate::plugin::capability::{PLUGIN_PROTOCOL_VERSION, ValidatedManifest};
use crate::plugin::contract::CapabilityDescriptor;
...
impl PluginProcessClient {
    ...
    pub async fn start_invocation(
        &self,
        capability_id: crate::plugin::capability::CapabilityId,
                ...
                if response.request_id == cancel_id {
                    match response.message {
                        ...
                        | ProtocolMessage::ErrorResponse {
                            error:
                                crate::plugin::protocol::StructuredError {
...
mod tests {
    ...
    fn tool_discovery() -> (CapabilityManifest, CapabilityDescriptor) {
        let id: crate::plugin::capability::CapabilityId = "tool:fixture".parse().unwrap();
        (
            CapabilityManifest {
